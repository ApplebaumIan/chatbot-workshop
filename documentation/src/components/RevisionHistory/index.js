...
export default function RevisionHistory(props) {
    ...
    useEffect(()=>{
        ...
        if (history == null){
            ...
            fetch(`https://api.github.com/repos/${process.env.ORG_NAME}/${process.env.PROJECT_NAME}/commits?path=documentation/`+location.pathname.substring(location.pathname.lastIndexOf('workshop/'))+".md", requestOptions)
